...
func templatesFancyHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/fancy.html", size: 7264, mode: os.FileMode(420), modTime: time.Unix(1497462966, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
