...
func cmdExconf(c *cli.Context) error {
	configuration := gontrib.Configuration{
		...
		Projects: []gontrib.Project{
			{Name: "nudoku", Description: "Ncurses sudoku game", Gitrepos: []string{"https://github.com/jubalh/nudoku"}, Tags: []string{"C", "Terminal", "Game"}, Role: "maintainer", OutFile: "nudoku.contribs"},
